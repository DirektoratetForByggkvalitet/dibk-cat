    ...
    <Primitives.Wizard>
      <IntroMain>
        ...
        <Primitives.Paragraphs.P>
          ...
          og uskyldig(?) liten katt. Det vil si om du kan ta ansvar for de delene av arbeidet som en
          katt vil kreve av deg, og at du står ansvarlig for at arbeidet utføres riktig. Vi hjelper
          deg også å lage en erklæring for ansvarsrett som du kan skrive ut, signere og sende til
          ansvarlig søker, men det er i en annen veiviser.<br />
        ...
        <Primitives.Paragraphs.P>
          Når du har fullført veiviseren får du vite om du kan skaffe deg katt eller ikke. I en
